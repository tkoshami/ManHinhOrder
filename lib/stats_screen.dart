...
// Một khung giờ bán hàng trong ngày
class _TimeSlot {
  final String label;
...
class _StatsScreenState extends State<StatsScreen> {
  ...
  // Ngày đang được xem (mặc định = hôm nay)
  DateTime _selectedDate = DateTime.now();

  // Khung giờ nào đang được mở rộng để xem breakdown theo giờ (null = chưa mở)
  ...
  // ─── Dữ liệu thật: đơn hàng đã thanh toán trong ngày đang chọn ───
  ...
  // Doanh thu theo từng khung giờ (Sáng/Trưa/Chiều/Tối)
  ...
  // Doanh thu theo từng giờ lẻ trong một khung giờ cụ thể (dùng khi mở rộng)
  ...
  // Toàn bộ món đã bán trong ngày đang chọn, gộp số lượng theo tên sản phẩm,
  // sắp xếp theo số lượng bán giảm dần (dùng cho dialog "xem tất cả")
  ...
  // Top 3 món bán chạy của ngày đang chọn
  ...
  Future<void> _pickDate() async {
    ...
    if (picked != null) {
      setState(() {
        ...
        _expandedSlotIndex = null; // đóng breakdown cũ khi đổi ngày
      });
    }
  }
    ...
    return SizedBox(
      ...
      child: Row(
        ...
        children: List.generate(_timeSlots.length, (index) {
          ...
          if (value > 0 && barHeight < 16) barHeight = 16; // luôn thấy được cột nếu có doanh thu
