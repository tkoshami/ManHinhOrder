...
class _SelfOrderScreenState extends State<SelfOrderScreen> {
  ...
  /// Tên bàn lấy từ query string `?table=...` của link QR (nếu khách quét
  /// mã QR riêng cho 1 bàn). null nếu khách vào bằng link chung, không
  /// gắn bàn cụ thể — khi đó đơn sẽ ghi nhận là "Khách QR (Mang đi)".
  String? _tableName;
        ...
        children: [
          if (_tableName != null)
            Container(
              ...
              child: Row(
                children: [
                  const Icon(Icons.table_restaurant, color: Colors.green, size: 18),
